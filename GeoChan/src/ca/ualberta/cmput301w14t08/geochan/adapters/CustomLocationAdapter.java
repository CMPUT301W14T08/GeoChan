...
/**
 * This class is an adapter to display a list of locations the user specified in the past.
 * Each list item consists of a title of the associated thread and geolocation represented by long and latt
 */
